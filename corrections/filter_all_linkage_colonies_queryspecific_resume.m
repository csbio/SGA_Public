...
function [all_linkage_cols, non_spec]  = filter_all_linkage_colonies_queryspecific_resume(sgadata, linkagefile, all_querys, all_arrays, query_map, array_map, lfid)
